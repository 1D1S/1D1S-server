...
public class ChallengeMutationResolver {
    ...
    @MutationMapping
    public ChallengeDto acceptApplicants(@Argument Long challengeId, @Argument List<Long> applicants) {
        return challengeMutationService.acceptApplicants(challengeId, applicants);
    }

    @MutationMapping
    public ChallengeDto rejectApplicants(@Argument Long challengeId, @Argument List<Long> applicants) {
