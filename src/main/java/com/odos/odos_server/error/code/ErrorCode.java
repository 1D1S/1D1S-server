...
public enum ErrorCode {
  ...
  INVALID_EMAIL(400, "AUTH-004", "Email is missing or invalid"),
  OAUTH_USER_NOT_FOUND(404, "AUTH-005", "User not found from OAuth provider"),
  INVALID_SIGNUP_PROVIDER(400, "AUTH-006", "Unexpected signup provider"),
  EMAIL_USER_NOT_FOUND(404, "AUTH-007", "User not found with given email"),
